...
def main():
    ...
    pretrained_model_path = "models\SmolVLA\pretrained_model"
    ...
    for _ in range(MAX_EPISODES):
        for _ in range(MAX_STEPS_PER_EPISODE):
            ...
            if random.random() < 0.2:
                ...
                Image.fromarray(captured_img).save(f"results/smolvlm/smolvlm_captured_image_{img_index}.png")
                img_index += 1
    ...
    with open("results/smolvlm/actions.csv", "w") as f:
